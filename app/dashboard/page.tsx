      ...
      <div className="min-h-screen bg-gray-100 p-4 pb-20 relative">
        <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-xl p-6">
          <Tabs defaultValue="profile">
            ...
            <TabsList className="fixed bottom-0 left-0 right-0 grid w-full grid-cols-6 bg-white border-t shadow-lg h-14">
              ...
              <TabsTrigger value="skills">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" color="#000000" fill="none">
                    ...
                    <path d="M20.5 18.9999C20.5 18.9999 19 18.4999 18.5 17.4999" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
